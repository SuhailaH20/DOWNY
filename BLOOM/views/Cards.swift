        ...
        var steps: [StepModel] {
            [
                StepModel(
                    ...
                    imageName: "TS1",
                    color: .babyBlue,
                    audioF: isArabic ? "TakingShowerAR1.mp3" : "TakingShower1.mp3"
                ),
                StepModel(
                    Icon: "",
                    title: String(localized: "Taking Shower"),
                    description: String(localized: "Children use shampoo and warm water to clean themselves."),
                    imageName: "TS2",
                    color: .babyBlue,
                    audioF: isArabic ? "TakingShowerAR2.mp3" : "TakingShower2.mp3"
                ),
                StepModel(
                    Icon: "",
                    title: String(localized: "Taking Shower"),
                    description: String(localized: "Children dry themselves thoroughly with a clean towel and wear clean clothes after."),
                    imageName: "TS3",
                    color: .babyBlue,
                    audioF: isArabic ? "TakingShowerAR3.mp3" : "TakingShower3.mp3"
                ),
                StepModel(
                    Icon: " ",
                    title: String(localized: "Good Job"),
        ...
        var steps: [StepModel] {
            [
                StepModel(
                    ...
                    imageName: "ST1",
                    color: .babyYellow,
                    audioF: isArabic ? "ScreenTimeAR1.mp3" : "ScreenTime1.mp3"
                ),
                StepModel(
                    Icon: "",
                    title: String(localized: "Screen Time"),
                    description: String(localized: "We feel angry, so we turn off the screen."),
                    imageName: "ST2",
                    color: .babyYellow,
                    audioF: isArabic ? "ScreenTimeAR2.mp3" : "ScreenTime2.mp3"
                ),
                StepModel(
                    Icon: "",
                    title: String(localized: "Screen Time"),
                    description: String(localized: "After the break, our body feels relaxed and happy, and we can enjoy our day again."),
                    imageName: "ST3",
                    color: .babyYellow,
                    audioF: isArabic ? "ScreenTimeAR3.mp3" : "ScreenTime3.mp3"
                ),
                StepModel(
                    Icon: " ",
                    title: String(localized: "Good Job"),
        ...
        var steps: [StepModel] {
            [
                StepModel(
                    ...
                    imageName: "WH1",
                    color: .babyBlue,
                    audioF: isArabic ? "WashingHandsAR1.mp3" : "WashingHands1.mp3"
                ),
                StepModel(
                    Icon: "",
                    title: String(localized: "Washing Hands"),
                    description: String(localized: "Children wash their hands after playing outside the house."),
                    imageName: "WH2",
                    color: .babyBlue,
                    audioF: isArabic ? "WashingHandsAR2.mp3" : "WashingHands2.mp3"
                ),
                StepModel(
                    Icon: "",
                    title: String(localized: "Washing Hands"),
                    description: String(localized: "So that the dirt has no chance of making them get sick."),
                    imageName: "WH3",
                    color: .babyBlue,
                    audioF: isArabic ? "WashingHandsAR3.mp3" : "WashingHands3.mp3"
                ),
                StepModel(
                    Icon: " ",
                    title: String(localized: "Good Job"),
